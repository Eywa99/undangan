...
export const weddingData: WeddingData = {
  ...
  groom: {
    ...
    instagram: "@syafri.design",
    instagramUrl: "https://instagram.com",
    photo: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=600",
  },
  bride: {
    shortName: "Siti Aisyah",
    fullName: "Siti Aisyah, S.Pd.",
    fatherName: "Bpk. H. Mahmud Rahmin",
    motherName: "Ibu Hj. Khadijah Abdullah",
    instagram: "@aisyah.arts",
    instagramUrl: "https://instagram.com",
  ...
  loveStory: [
    {
      ...
      story: "Takdir mempertemukan kami pertama kali di sebuah kegiatan seminar kampus. Sebuah sapaan singkat menjadi awal dari kisah panjang kami.",
    ...
    },
    {
      ...
      story: "Seiring berjalannya waktu, komitmen dan rasa saling memahami tumbuh semakin kuat. Kami berjanji untuk saling mendukung dalam meraih impian masing-masing.",
    ...
    },
    {
      ...
      story: "Insya Allah, kami akan menyempurnakan separuh agama dalam ikatan suci pernikahan, melangkah bersama membangun keluarga yang sakinah, mawaddah, warahmah.",
